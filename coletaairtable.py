...
base_key = 'appUqTkHvVKGG1KID'
table_name = 'dados'
api_key = 'patheoR93sEM6nDZI.98e3a07abd90e1232ac642b91c7637746d8e58b3ddb474a784aa0e94ab860bff'
...
if confirm_button:
    ...
    st.success("Dados confirmados e inseridos no Airtable!")
